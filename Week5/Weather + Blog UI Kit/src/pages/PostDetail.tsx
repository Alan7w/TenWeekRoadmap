    ...
    if (error) {
        return (
            <div className="postCardStyle">
                ...
                <br />
                <Button size="large" variant="outlined" onClick={() => window.location.reload()}>Try again</Button>
            </div>
        )
    }
        ...
        <div>
            ...
            <div className='postCardStyle'>
                ...
                <div className="postsNavigationContainer">
                    <Button variant="secondary" onClick={() => navigate(`/blog/${id ? parseInt(id) - 1 : 0}`)}>Previous Post</Button>
                    <Button variant="secondary" onClick={() => navigate(`/blog/${id ? parseInt(id) + 1 : 0}`)}>Next Post</Button>
                </div>
